...
def fill_missing_values(df):
    ...
    index = df['taxvaluedollarcnt'].notnull() & df['taxamount'].isnull()
    df.loc[index, 'taxamount'] = df[index]['taxvaluedollarcnt'] / 73
    # use taxvaluedollarcnt - landtaxvaluedollarcnt to impute structuretaxvaluedollarcnt
    index = df['taxvaluedollarcnt'].notnull() & df['landtaxvaluedollarcnt'].notnull() \
            & df['structuretaxvaluedollarcnt'].isnull()
    df.loc[index, 'structuretaxvaluedollarcnt'] = df[index]['taxvaluedollarcnt'] - \
                                                  df[index]['landtaxvaluedollarcnt']
...
print('>>>> best_param')
best_params['num_leaves'] = 512
clf = lgb.train(best_params, d_train, 430)
